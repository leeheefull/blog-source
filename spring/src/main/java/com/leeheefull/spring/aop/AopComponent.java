package com.leeheefull.spring.aop;
...
public class AopComponent {
     ...
     */
    @Pointcut("execution(* com.leeheefull.spring.aop.controller..*.*(..))")
    private void cut() {
    }

    @Pointcut("@annotation(com.leeheefull.spring.aop.annotation.Timer)")
